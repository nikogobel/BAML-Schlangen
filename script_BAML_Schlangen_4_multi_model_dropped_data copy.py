...
def train_model(search, X_train, y_train):
...
def evaluate_model(model, search, X_val, y_val):
    ...
    print("Balanced Validation Accuracy:", balanced_accuracy_score(y_val, pred_val))
    print("Score on validation set:", search.score(X_val, y_val.values.ravel()))
...
def compute_prediction():
    ...
    # train the models
    model = train_model(search, X_train, y_train)
    
    evaluate_model(model, search, X_val, y_val)
